                    ...
                    <div className="flex h-16 items-center justify-between">
                            ...
                            <div className="hidden md:block ml-20">
                                <div className="relative">
                                    <div className="flex items-center">
                                        <input
                                            type="text"
                                            className=" pl-14 pr-16 py-2 border rounded-[20px]"
                                            placeholder="Search..."
                                        />
                        ...
                        <div className="hidden md:block">
                            <div className="ml-4 flex items-center md:ml-6">
                                <button
                                    type="button"
                                    className="text-white bg-blue-700 font-bold rounded-[10px] px-2.5 py-2 text-center justify-center items-center mr-1"
                                >
                                    Login
                                </button>
                                ...
                                <button
                                    type="button"
                                    className="text-white bg-blue-700 font-bold rounded-[10px] px-2.5 py-2 text-center mr-1 justify-center items-center"
                                >
                                    Register
                                </button>
                            </div>
                ...
                {close ? <div className="md:hidden" id="mobile-menu">
                    <div className="border-t border-gray-700 pb-3 pt-4">
                        <div className="mt-3 space-y-1 px-2">
                            <a href="#" className="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Login</a>
                            <a href="#" className="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Register</a>
                        </div>
                    </div>
                </div> : ""}
            </nav>
